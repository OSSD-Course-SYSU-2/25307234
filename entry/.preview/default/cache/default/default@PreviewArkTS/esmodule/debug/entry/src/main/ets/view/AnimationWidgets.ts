...
export class AnimationWidgets extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/AnimationWidgets.ets(50:5)", "entry");
            Stack.width(Common.DEFAULT_FULL_WIDTH);
            Stack.layoutWeight(1);
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/AnimationWidgets.ets(51:7)", "entry");
            Stack.width(Common.DEFAULT_FULL_WIDTH);
        ...
        Stack.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.mainFlag ? { "id": 16777224, "type": 20000, params: [], "bundleName": "com.example.animation", "moduleName": "entry" } : { "id": 16777225, "type": 20000, params: [], "bundleName": "com.example.animation", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/view/AnimationWidgets.ets(68:7)", "entry");
            Image.width({ "id": 16777244, "type": 10002, params: [], "bundleName": "com.example.animation", "moduleName": "entry" });
            Image.height({ "id": 16777244, "type": 10002, params: [], "bundleName": "com.example.animation", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777231, "type": 10003, params: [], "bundleName": "com.example.animation", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/AnimationWidgets.ets(81:7)", "entry");
            ...
            Text.fontColor({ "id": 16777220, "type": 10001, params: [], "bundleName": "com.example.animation", "moduleName": "entry" });
